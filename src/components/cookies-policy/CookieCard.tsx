...
function CookieCard({ icon: Icon, index, title, description, purpose, extras, canDisable }: CookieCardProps) {
  return (
    <motion.div
      ...
      className="p-6 bg-muted border border-border rounded-xl hover:border-accent/30 hover:bg-muted/80 transition-all"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className={`${mutedBodyTextClass} space-y-2 pt-1`}>
            ...
            <p>
              <strong className="text-foreground">Can be disabled:</strong>{" "}
